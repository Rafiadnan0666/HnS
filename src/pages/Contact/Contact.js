  ...
  return (
    <div className="font-poppins bg-white w-full px-0 z-50" style={{ position: "relative", zIndex: 100, backgroundColor: "white" }}>
      ...
      <div className="mb-16 text-left px-6 md:px-12">
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold mb-4">PRICE LIST</h1>
        <h2 className="text-2xl font-bold">LIVE CUMA Rp. 25.000-an</h2>
      </div>
      ...
      <div className="flex flex-col gap-0 w-full bg-gray-100">
        ...
        <div className="p-6 md:p-12 bg-gray-200 w-full flex flex-col justify-center">
          ...
          <h3 className="text-base md:text-xl lg:text-[1.5rem] text-gray-700 font-garamond">Note:</h3>
          <p className="text-base md:text-xl lg:text-[1.5rem] text-gray-700 font-garamond">
            Live 4 Jam per hari dengan minimal order 5 hari di 1 platform pilihan <br />Pilih waktu di luar jadwal yang tertera dikenai biaya tambahan 5% per paket <br />Minimal order 3 hari
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-0 mt-12 w-full bg-gray-100">
        ...
        <div className="p-6 md:p-12 bg-gray-300 w-full flex flex-col justify-center">
          ...
          <h3 className="text-base md:text-xl lg:text-[1.5rem] text-gray-700 font-garamond">Note:</h3>
          <p className="text-base md:text-xl lg:text-[1.5rem] text-gray-700 font-garamond">
            Live 4 Jam per hari di 1 platform pilihan, untuk tambahan platform lain dikenakan biaya 90%. <br />Pilih waktu sesuai kebutuhan live online shop anda. <br />Setiap 1 jam tambahan dikenakan biaya Rp. 25.000.
          </p>
        </div>
        ...
        <div className="p-6 md:p-12 bg-gray-200 w-full flex flex-col justify-center">
          ...
          <h3 className="text-base md:text-xl lg:text-[1.5rem] text-gray-700 font-garamond">Note:</h3>
          <p className="text-base md:text-xl lg:text-[1.5rem] text-gray-700 font-garamond">
            Live 6 Jam per hari di 1 platform pilihan, untuk tambahan platform lain dikenakan biaya 90%. <br />Pilih waktu sesuai kebutuhan live online shop anda. <br />Setiap 1 jam tambahan dikenakan biaya Rp. 25.000.
          </p>
        </div>
      </div>
    </div>
